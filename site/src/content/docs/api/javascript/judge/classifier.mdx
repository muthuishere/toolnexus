...
| `decisions` | `RecordedDecision[]` | — | **JavaScript-local naming.** `style: "static"` only — the recorded corpus. |

`decisions` is not in the cross-port options manifest; everything above it is.
