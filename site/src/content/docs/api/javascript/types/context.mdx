...
Cancellation follows each language's convention: JavaScript carries an `AbortSignal`, Go carries a
`context.Context`. And `timeout` is **milliseconds** in JavaScript, Go and Java, but **seconds** in
Python — check the port's page before you divide by a thousand.
</Aside>
