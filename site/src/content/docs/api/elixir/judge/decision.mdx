...
reports **false** unless it derived its probabilities from provider token probabilities. It is the
flag that tells you whether a threshold you tuned is meaningful — and **a threshold tuned against
