...
var agent = new Agent("plain", new AgentSpec { Does = "answers" });
...
var agent = new Agent("gated", new AgentSpec
{
    Does = "plans",
...
var never = new Agent("never", new AgentSpec
{
    Does = "never verifies",
...
var bad = new Agent("bad", new AgentSpec
{
    Does = "x",
...
var delegator = new Agent("delegator", new AgentSpec
{
    Does = "x",
    Team = new List<Agent> { new("child", new AgentSpec { Does = "helps" }) },
});
