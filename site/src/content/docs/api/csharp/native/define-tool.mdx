...
<Aside type="tip" title="Use [ToolMethod] + Tools.Collect when you have many">
...
and [`Tools.Collect`](/api/csharp/native/collect/) sweeps a whole class of them in one call. Go the
...
- [`Tools.Collect`](/api/csharp/native/collect/) — sweep a class for annotated methods
