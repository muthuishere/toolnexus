...
Cancellation follows each language's convention: Java uses an `AtomicBoolean`, JavaScript an
`AbortSignal`, Go a `context.Context`. And the timeout is **milliseconds** in Java, JavaScript and
Go, but **seconds** in Python.
</Aside>
