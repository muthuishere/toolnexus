...
— those ports build tools individually instead. Behavior (schema inference, skip-if-unannotated)
matches wherever the capability exists. See [SPEC §0](https://github.com/muthuishere/toolnexus/blob/main/SPEC.md).
