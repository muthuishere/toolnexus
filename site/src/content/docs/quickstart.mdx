---
title: Quickstart
description: Zero to a working agent in three steps — install, point at your tools, run. Same shape in JavaScript, Python, Go, Java and C#.
---
...
<div class="tn-video-placeholder">
	<span class="tn-video-badge">Quickstart video · coming soon</span>
	<span class="tn-video-play">▶</span>
	<span class="tn-video-title">Watch the JavaScript quickstart</span>
	<span class="tn-video-note">A narrated walkthrough — typed live in the editor, then run — lands here.</span>
</div>
