...
<div class="tn-video-placeholder">
	<span class="tn-video-badge">Featured demo · coming soon</span>
	<span class="tn-video-play">▶</span>
	<span class="tn-video-title">Five sources, one loop, one human decision</span>
	<span class="tn-video-note">The narrated walkthrough — typed live, then run end-to-end — lands here.</span>
</div>
