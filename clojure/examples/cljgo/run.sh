#!/usr/bin/env bash
# The same seven examples on cljgo — AOT binary AND interpreted, because a port
...
declare -a NAMES=(demo native_and_http skills persona_memory compaction multimodal judge)
